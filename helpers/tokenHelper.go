...
func GenrateAllTokens(email string, firstName string, lastName string, userType string, uid string) (signedToken string, signedRefreshToken string, err error) {
...
func UpdateAllTokens(signedToken string, signedRefreshToken string, userId string) {
	...
	_, err := userCollection.UpdateOne(ctx, filter, bson.D{ {"$set", updatedObj},},&opt,)
	defer cancel()
	if err != nil {
		log.Panic(err)
		return
